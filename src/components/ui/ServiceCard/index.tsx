...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-black transition-opacity duration-100 opacity-0 z-10 lg:group-hover:opacity-100"></div>
      ...
      <div className="h-full flex items-center justify-center">
        <div className="flex flex-col items-center lg:items-start justify-center z-20 gap-4 lg:gap-0">
          <div className="icon-container relative w-12 h-11 lg:mb-6">
            <img
              className="w-full h-full icon absolute transition-opacity duration-300 opacity-100 lg:group-hover:opacity-0"
              src={iconSrc}
              alt="Icon"
            />
            {iconHoverSrc && (
              <img
                className="w-full h-full filled-icon absolute transition-opacity duration-300 opacity-0 lg:group-hover:opacity-100"
                src={iconHoverSrc}
                alt="Icon"
              />
            )}
